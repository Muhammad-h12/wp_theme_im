 ...
 */
	...
	<footer id="wp-footer" class="clearfix">
		<?php $footer = apply_filters('enzio_get_footer_layout', null ); $footer;  ?>
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-12 col-xs-12">
						<?php echo enzio_get_option('copyright_text', esc_html__('Copyright ', 'enzio') . date('Y') . ' - ' . esc_html__('Company - All rights reserved. Powered by WordPress.', 'enzio') ); ?>
					</div>
				</div>	
			</div>
		</div>

		<?php if(enzio_get_option('enable_backtotop', 0) == 1){ ?>
